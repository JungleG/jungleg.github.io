...
在找工作的过程中，经常被问到各种各样的问题，顿感自己基础的薄弱。于是想到建立一个博客记录自己的日常，也是对一个知识的总结。

本人对于前端不甚了解，于是借用了[HyG](https://gaohaoyang.github.io/)大大的jekyll模板，在此表示感谢。希望日后也能独创一个网站。

**这是我的博客地址：[http://jungleg.github.io/](http://jungleg.github.io/)**。之后也会不断更新维护，若您喜欢这个新的博客主题，请给我个star以示鼓励吧，欢迎大家使用。
...
文章中`<!--more-->`为摘要分割符，换行前的内容会以摘要的形式显示在主页Home上，进入文章页不影响。
