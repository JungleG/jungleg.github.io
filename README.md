...
In the process of finding a job, there are a variety of questions, which shows that my basic konwledge is weak. So I thought to build a blog to record everyday learning, but also a summary of knowledge.

I am not familiar with the web-design technology, so I borrowed [HyG's jekyll template](https://gaohaoyang.github.io/). I would like to express my thanks here. Hope to create a website the future.

**This is My Blog Url: [http://jungleg.github.io/](http://jungleg.github.io/)**. The site will be updated and maintained. If you like this theme, you can give me a star to encourage me. Welcome everyone to use it.
